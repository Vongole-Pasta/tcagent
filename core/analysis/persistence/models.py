...
프로퍼티명은 graph_db/schema.py의 OGM 모델과 정렬되어 있습니다.
"""
...
class ParsedType:
    ...
    constants: str = ""     # ENUM 전용: ConstantInfo JSON 문자열
...
class ParsedMethod:
    ...
    params: list[dict]      # list[ParamInfo]: [{"name": ..., "type": {"given": ..., "layout": [...]}}]
    return_type: Optional[dict]  # TypeInfo: {"given": ..., "layout": [...]}
...
class ParsedParameterEdge:
    ...
    param_info: dict        # ParamInfo dict
...
class ParsedReturnEdge:
    ...
    method_qualname: str    # METHOD의 qualname
    return_info: dict       # TypeInfo dict
